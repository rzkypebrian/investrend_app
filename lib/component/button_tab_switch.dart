...
class ButtonTabSwitch extends StatelessWidget {
  ...
  const ButtonTabSwitch(this.labels, this.buttonNotifier,
      {this.minWidthButton, this.paddingButton, Key? key})
      : super(key: key);
    ...
    if (count > 0) {
      return ValueListenableBuilder(
        ...
        builder: (context, int selectedIndex, child) {
          ...
          TextStyle selectedStyle = InvestrendTheme.of(context)
              .regular_w600_compact!
              .copyWith(color: Theme.of(context).tabBarTheme.labelColor);
          TextStyle unselectedStyle = InvestrendTheme.of(context)
              .regular_w600_compact!
              .copyWith(
                ...
                if (minWidthButton == null) {
                  return MaterialButton(
                    ...
                    padding: paddingButton ??
                        EdgeInsets.all(InvestrendTheme.cardPaddingGeneral),
