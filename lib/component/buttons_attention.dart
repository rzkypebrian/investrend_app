...
class ButtonCorporateAction extends StatelessWidget {
  ...
  const ButtonCorporateAction(this.height, this.background_color, this.onPressed, {this.style, this.padding, Key key}) : super(key: key);
    ...
    return Padding(
      ...
      child: ConstrainedBox(
        ...
        child: MaterialButton(
          minWidth: height,
          padding: padding ?? EdgeInsets.only(left: 12.0, right: 12.0, top: 1.0, bottom: 1.0),
          ...
          child: AutoSizeText(
            ...
            maxLines: 1,
            minFontSize: 5.0,
            style: style ?? InvestrendTheme.of(context).small_w600_compact.copyWith(color: InvestrendTheme.of(context).whiteColor),
          ),
...
class ButtonSpecialNotationAnimation extends StatefulWidget {
  ...
  const ButtonSpecialNotationAnimation(this.height, this.onPressed, this.stockInformationStatus,
      {this.padding, this.animateSpecialNotationNotifier, Key key})
      : super(key: key);

  @override
  _ButtonSpecialNotationAnimationState createState() => _ButtonSpecialNotationAnimationState();
}

class _ButtonSpecialNotationAnimationState extends State<ButtonSpecialNotationAnimation> with TickerProviderStateMixin {
  ...
  @override
  Widget build(BuildContext context) {
    String image = widget.stockInformationStatus != null ? widget.stockInformationStatus.image : 'images/icons/special_notation.png';
    if (StringUtils.isEmtpy(image)) {
      image = 'images/icons/special_notation.png';
    }
    Widget button = ConstrainedBox(
      constraints: BoxConstraints(maxHeight: widget.height, minWidth: widget.height),
      child: MaterialButton(
        minWidth: widget.height,
        padding: widget.padding ?? EdgeInsets.only(left: 12.0, right: 12.0, top: 1.0, bottom: 1.0),
        shape: CircleBorder(),
    ...
    if (widget.animateSpecialNotationNotifier != null) {
      return ScaleTransition(
          scale: _tween.animate(CurvedAnimation(parent: _controller, curve: Curves.easeInOutCubic)),
          child: button);
    } else {
      return button;
    }
...
class ButtonSpecialNotation extends StatelessWidget {
  ...
  const ButtonSpecialNotation(this.height, this.onPressed, this.stockInformationStatus,
      {this.padding, this.animateSpecialNotationNotifier, Key key})
      : super(key: key);
...
class ButtonTextAttention extends StatelessWidget {
  ...
  const ButtonTextAttention(this.text, this.height, /*this.background_color,*/ this.onPressed, {this.style, this.padding, Key key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ConstrainedBox(
      ...
      child: MaterialButton(
        minWidth: height,
        padding: padding ?? EdgeInsets.only(left: 15.0, right: 15.0, top: 1.0, bottom: 1.0),
        // shape: RoundedRectangleBorder(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(
            ...
            color: onPressed != null ? InvestrendTheme.attentionColor : Colors.transparent,
          ),
        ),
        elevation: 0.0,
        visualDensity: VisualDensity.compact,
        child: AutoSizeText(
          ...
          maxLines: 1,
          minFontSize: 5.0,
          style: style ?? InvestrendTheme.of(context).small_w600_compact.copyWith(color: InvestrendTheme.attentionColor),
        ),
        //color: background_color ?? Color(0xFFAD5E0C),
...
class ButtonTextAttentionMozaic extends StatefulWidget {
  ...
  const ButtonTextAttentionMozaic(this.text, this.height, this.stockInformationStatus, /*this.background_color,*/
      this.onPressed,
      {this.style, this.padding, this.animateSpecialNotationNotifier, Key key})
      : super(key: key);

  @override
  State<ButtonTextAttentionMozaic> createState() => _ButtonTextAttentionMozaicState();
}

class _ButtonTextAttentionMozaicState extends State<ButtonTextAttentionMozaic> with TickerProviderStateMixin{
  ...
  Widget characterWidget(BuildContext context, double size, String character) {
    return Container(
      ...
      child: AutoSizeText(
        ...
        minFontSize: 1.0,
        //style: widget.style ?? InvestrendTheme.of(context).small_w600_compact.copyWith(color: InvestrendTheme.attentionColor),
        style: widget.style ?? InvestrendTheme.of(context).small_w600_compact.copyWith(color: Theme.of(context).primaryColor),
        group: group,
  ...
  Widget build(BuildContext context) {
    ...
    Widget button = ConstrainedBox(
      ...
      constraints: BoxConstraints(maxHeight: widget.height, minWidth: width, maxWidth: width),
      child: MaterialButton(
        //minWidth: widget.height,
        minWidth: width,
        //padding: widget.padding ?? EdgeInsets.only(left: 15.0, right: 15.0, top: 1.0, bottom: 1.0),
        padding: widget.padding ?? EdgeInsets.only(left: 2.0, right: 2.0, top: 2.0, bottom: 2.0),
        // shape: RoundedRectangleBorder(
        //   borderRadius: BorderRadius.circular(2.0),
        // ),
