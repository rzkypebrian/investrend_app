...
class ChartBarTripleLine extends StatelessWidget {
  final List<YearValue> data_bar;
  final List<YearValue> data_line_2;
  final List<YearValue> data_line_3;
  final List<YearValue> data_line_1;

  final String title_bar;
  final String title_line_2;
  final String title_line_3;
  final String title_line_1;

  final Color color_bar;
  final Color color_line_2;
  final Color color_line_3;
  final Color color_line_1;

  final bool animate;

  const ChartBarTripleLine(
      this.data_bar, this.data_line_1, this.data_line_2, this.data_line_3
      , this.title_bar, this.title_line_1, this.title_line_2, this.title_line_3,
      this.color_bar, this.color_line_1, this.color_line_2, this.color_line_3,{Key key, this.animate = false}) : super(key: key);
    ...
    return Column(
      ...
      children: [
        ...
        Expanded(
          ...
          child: Stack(
            ...
            children: [
              ...
              new charts.OrdinalComboChart(_createData(),
                animate: animate,
        ...
        ChartSeriesLegend(
          ...
          text_1: title_line_3,
          color_1: color_line_3,
          shape_1: LegendShape.Line,

          text_2: title_line_2,
          color_2: color_line_2,
          shape_2: LegendShape.Line,

          text_3: title_line_1,
          color_3: color_line_1,
          shape_3: LegendShape.Line,
  ...
  List<charts.Series<YearValue, String>> _createData() {
    ...
    return [
      new charts.Series<YearValue, String>(
          ...
          colorFn: (_, __) => ChartColor(color_bar).shadeDefault,
          domainFn: (YearValue sales, _) => sales.year,
          measureFn: (YearValue sales, _) => sales.value,
          //strokeWidthPxFn: (YearValue sales, _) => 10.0,
      ...
      new charts.Series<YearValue, String>(
          ...
          data: data_line_2)..setAttribute(charts.measureAxisIdKey, secondaryMeasureAxisId)
      ...
      new charts.Series<YearValue, String>(
          ...
          data: data_line_3)..setAttribute(charts.measureAxisIdKey, secondaryMeasureAxisId)
      // Set the 'Los Angeles Revenue' series to use the secondary measure axis.
      // All series that have this set will use the secondary measure axis.
      // All other series will use the primary measure axis.
      ,
      ...
      new charts.Series<YearValue, String>(
          id: title_line_1,
          //colorFn: (_, __) => charts.MaterialPalette.deepOrange.shadeDefault,
          colorFn: (_, __) => ChartColor(color_line_1).shadeDefault,
          domainFn: (YearValue sales, _) => sales.year,
          measureFn: (YearValue sales, _) => sales.value,
          data: data_line_1)
      // Configure our custom line renderer for this series.
        ..setAttribute(charts.rendererIdKey, 'customLine')..setAttribute(charts.measureAxisIdKey, secondaryMeasureAxisId),


      new charts.Series<YearValue, String>(
          id: title_line_2,
          //colorFn: (_, __) => charts.MaterialPalette.blue.shadeDefault,
          colorFn: (_, __) => ChartColor(color_line_2).shadeDefault,
          domainFn: (YearValue sales, _) => sales.year,
          measureFn: (YearValue sales, _) => sales.value,
          data: data_line_2)
      // Configure our custom line renderer for this series.
      ...
      new charts.Series<YearValue, String>(
          ...
          colorFn: (_, __) => ChartColor(color_line_3).shadeDefault,
          domainFn: (YearValue sales, _) => sales.year,
          measureFn: (YearValue sales, _) => sales.value,
          data: data_line_3)
      // Configure our custom line renderer for this series.
