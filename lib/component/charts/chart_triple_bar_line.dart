...
class ChartTripleBarLine extends StatelessWidget {
  final List<YearValue> data_bar_1;
  final List<YearValue> data_bar_2;
  final List<YearValue> data_bar_3;
  final List<YearValue> data_line;

  final String title_bar_1;
  final String title_bar_2;
  final String title_bar_3;
  final String title_line;

  final Color color_bar_1;
  final Color color_bar_2;
  final Color color_bar_3;
  final Color color_line;

  final bool animate;


  const ChartTripleBarLine(
      this.data_bar_1, this.data_bar_2, this.data_bar_3, this.data_line
      , this.title_bar_1, this.title_bar_2, this.title_bar_3, this.title_line,
      this.color_bar_1, this.color_bar_2, this.color_bar_3, this.color_line,{Key key, this.animate = false}) : super(key: key);
  ...
  List<charts.Series<YearValue, String>> _createData() {
    ...
    return [
      ...
      new charts.Series<YearValue, String>(
          ...
          colorFn: (_, __) => ChartColor(color_bar_3).shadeDefault,
          domainFn: (YearValue sales, _) => sales.year,
          measureFn: (YearValue sales, _) => sales.value,
