...
class FastOrderbook extends StatefulWidget {
  ...
  const FastOrderbook(this.notifier, this._orderType, this.maxShowLevel,
      {Key key, this.owner = '' /*, this.orderDataNotifier, this.calculateNotifier*/
      })
      : super(key: key);
...
class _FastOrderbookState extends State<FastOrderbook> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        print('FastOrderbook [' + widget._orderType.routeName + '] constrains ' + constraints.maxWidth.toString());
  ...
  */
  ...
  Widget buildOrderbookNew(BuildContext context, double widthWidget, double heightWidget) {
  ...
  double useFontSize(BuildContext context, double fontSize, double widthSection, OrderBook value, {int offset = 0}) {
    ...
    print('FastOrderbook[' + widget.owner + '].useFontSize Final fontSize  : $fontSize  offset : $offset');
    return fontSize;
  }
  ...
  */
  ...
  Widget createLabelOpenNew(BuildContext context, double fontSize, int openLot, TextAlign textAlign) {
    return Padding(
      padding: const EdgeInsets.only(top: 5.0, bottom: 5.0),
      child: RichText(
        textAlign: textAlign,
  ...
  Widget createTextField(BuildContext context, Key fieldKey, double fontSize, TextEditingController controller, FocusNode focusNode, {FocusNode nextFocusNode }){
    return TextField(
      controller: controller,
      key: fieldKey,
