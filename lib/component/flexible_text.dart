...
class FlexibleText extends StatefulWidget {
  ...
  /// Creates a [FlexibleText] widget with a [TextSpan].
  ...
  /// Synchronizes the size of multiple [FlexibleText]s.
  ///
  /// If you want multiple [FlexibleText]s to have the same text size, give all
  /// of them the same [FlexibleTextGroup] instance. All of them will have the
  /// size of the smallest [FlexibleText]
  final FlexibleTextGroup? group;
  ...
  @override
  _FlexibleTextState createState() => _FlexibleTextState();
}
...
class _FlexibleTextState extends State<FlexibleText> {
  ...
  @override
  void didUpdateWidget(FlexibleText oldWidget) {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, size) {
      ...
      if (style?.fontSize == null) {
        style = style?.copyWith(fontSize: FlexibleText._defaultFontSize);
      }
...
class FlexibleTextGroup {
  final _listeners = <_FlexibleTextState, double>{};
  var _widgetsNotified = false;
  double _fontSize = double.infinity;

  _register(_FlexibleTextState text) {
    _listeners[text] = double.infinity;
  }

  _updateFontSize(_FlexibleTextState text, double maxFontSize) {
  ...
  _remove(_FlexibleTextState text) {
