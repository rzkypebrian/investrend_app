...
class RowPortfolio extends StatelessWidget {
  ...
  Widget rowPortfolio(BuildContext context) {
    ...
    gainLossText  = gainLossText+' ('+InvestrendTheme.formatPercent(portfolio.gainLossPercent, prefixPlus: true)+')';

    Color marketColor = InvestrendTheme.priceTextColor(portfolio.change);
    String changeText  = InvestrendTheme.formatMoney(portfolio.change,prefixPlus: true, prefixRp: false);
    changeText  = changeText+' ('+InvestrendTheme.formatPercent(portfolio.percentChange, prefixPlus: true)+')';
    
    String lotAverage = InvestrendTheme.formatComma(portfolio.lot)+' Lot | Avg ';
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        InvestrendTheme.getChangeImageInt(portfolio.change, size: 8.0),
                        Text(InvestrendTheme.formatPrice(portfolio.close), style: regular700.copyWith(color: marketColor)),
                      ],
                    ),
                    SizedBox(height: 5.0,),
                    FittedBox(
