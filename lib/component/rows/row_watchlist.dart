...
class RowWatchlist extends StatelessWidget {
  ...
  Widget bestPriceLot(
      BuildContext context, String? label, int? price, int? lot) {
    if (price == 0 || lot == 0) {
        ...
        TextSpan(
          ...
          children: [
            TextSpan(
              text: '-',
              style:
                  InvestrendTheme.of(context).support_w400_compact_greyLighter,
            ),
          ],
        ),
        group: groupBest,
        ...
        children: [
          TextSpan(
            ...
            style: InvestrendTheme.of(context).support_w400_compact?.copyWith(
                color: InvestrendTheme.priceTextColor(price,
                    prev: data?.prevPrice)),
          ),
          TextSpan(
            text: ' x ',
  ...
  static double calculateWidthRight(BuildContext? context, double? price,
    ...
    String percentChangeText =
        InvestrendTheme.formatNewPercentChange(percentChange);
    String changePercentChangeText =
  ...
  Widget rowWithName(BuildContext context) {
    ...
    String percentChangeText =
        InvestrendTheme.formatNewPercentChange(data?.percent);
    ...
    Size textSize = UIHelper.textSize(
        'ABCD', InvestrendTheme.of(context).regular_w600_compact!);
    ...
    if (data?.notation != null &&
        (data!.notation!.isNotEmpty ||
            data?.status == StockInformationStatus.Suspended)) {
        ...
        children: [
          ...
          Text(
            ...
            style: InvestrendTheme.of(context)
                ...
                ?.copyWith(color: data?.priceColor),
          ),
        ],
      ),
      SizedBox(
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    flex: 1,
                    child: bestPriceLot(
                        context, 'Bid', data?.bestBidPrice, data?.bestBidLot()),
                  ),
                  Expanded(
                    flex: 1,
                    child: bestPriceLot(context, 'Ask', data?.bestOfferPrice!,
                        data?.bestOfferLot()),
                  ),
                ],
              )),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          flex: 1,
                          child: bestPriceLot(context, 'Bid',
                              data?.bestBidPrice, data?.bestBidLot()),
                        ),
                        SizedBox(
                          width: 5.0,
                        ),
                        Expanded(
                          flex: 1,
                          child: bestPriceLot(context, 'Ask',
                              data?.bestOfferPrice, data?.bestOfferLot()),
                        ),
                      ],
                    ),
                  ],
