...
class BuySell {
  ...
  TransactionType transactionType = TransactionType.Normal;// 0 = normal   1 = Loop   2 = SPLIT
  ...
  String toString() {
    ...
    listFastPriceLot.forEach((element) {
      if(StringUtils.isEmtpy(fastPriceLot)){
        ...
        fastPriceLot = fastPriceLot+'\n  ['+index.toString()+'] '+element.toString();
      }
      index++;
    });
    return 'BuySell : ' +
        ...
        '\n  transactionType : ' +transactionType.index.toString() +
        ...
        '\n  listFastPriceLot.length : '+listFastPriceLot.length.toString() +
        '\n  {$fastPriceLot}'
    ;
  }

  void setAccount(String _accountName, String _accountType, String _accountCode, String _brokerCode) {
  ...
  void setNormalPriceLot(int price, int lot,{TransactionType transactionType, int transactionCounter, int totalValue = 0,}) {
