...
class _ScreenEIPOState extends BaseStateWithTabs<ScreenEIPO> {
  ...
  void didChangeDependencies() {
    ...
    styleLabel = InvestrendTheme.of(context).support_w500.copyWith(fontSize: InvestrendTheme.of(context).support_w500.fontSize+1);
    styleContent = InvestrendTheme.of(context).support_w400.copyWith(color: InvestrendTheme.of(context).greyDarkerTextColor,height: 1.35);
  }
  ...
  Widget createTabCompanyDetail(BuildContext context, double paddingBottom, ContentEIPO ipo){
    ...
    List<Widget> childs = [
      Text('eipo_stock_code'.tr(), style: styleLabel,),
      Text(ipo.code, style: styleContent,),
      SizedBox(height: paddingContent,),

      Text('eipo_sector'.tr(), style: styleLabel,),
      Text(ipo.sector, style: styleContent,),
      SizedBox(height: paddingContent,),

      Text('eipo_subsector'.tr(), style: styleLabel,),
      Text(ipo.sub_sector, style: styleContent,),
      SizedBox(height: paddingContent,),

      Text('eipo_company_description'.tr(), style: styleLabel,),
      Text(ipo.company_description, style: styleContent,),
      SizedBox(height: paddingContent,),

      Text('eipo_address'.tr(), style: styleLabel,),
      Text(ipo.company_address, style: styleContent,),
      SizedBox(height: paddingContent,),
      ...
      Text(InvestrendTheme.formatComma(ipo.offering_lot), style: styleContent,),
      SizedBox(height: paddingContent,),

      Text('eipo_percentage_of_total_share'.tr(), style: styleLabel,),
      Text(InvestrendTheme.formatPercent(ipo.offering_lot_percentage), style: styleContent,),
      SizedBox(height: paddingContent,),
      Text('eipo_partisipant_admin'.tr(), style: styleLabel,),
    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('eipo_shared_offered'.tr(), style: styleLabel,),
            Text(InvestrendTheme.formatComma(ipo.offering_lot)+' Lot', style: styleContent,),
            SizedBox(height: paddingContent,),

            Text('eipo_book_building'.tr(), style: styleLabel,),
            Text(bookbuilding, style: styleContent,),
            SizedBox(height: paddingContent,),

            Text('eipo_offering'.tr(), style: styleLabel,),
            Text(offering, style: styleContent,),
            SizedBox(height: paddingContent,),

            Text('eipo_allotment'.tr(), style: styleLabel,),
            Text(ipo.allotment_date, style: styleContent,),
            SizedBox(height: paddingContent,),

            Text('eipo_distribution'.tr(), style: styleLabel,),
            Text(ipo.distribution_date, style: styleContent,),
            SizedBox(height: paddingContent,),

            Text('eipo_listing_date'.tr(), style: styleLabel,),
            Text(ipo.listing_date, style: styleContent,),
            SizedBox(height: paddingContent,),

            Text('eipo_prospectus'.tr(), style: styleLabel,),
            Row(
            ...
            Text('eipo_additional_information'.tr(), style: styleLabel,),
