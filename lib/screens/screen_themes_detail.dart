...
class _ScreenThemesDetailState extends VisibilityAwareState<ScreenThemesDetail> {
  ...
  */
  ...
  Widget createBody(BuildContext context, double paddingBottom) {
    ...
    pre_childs.add(Stack(
      ...
      children: [
        ...
        AspectRatio(
          aspectRatio: 1 / 1,
          child: ComponentCreator.imageNetworkCached(widget.themes.background_image_url, fit: BoxFit.fitHeight),
        ),
        Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                widget.themes.getName(language: EasyLocalization.of(context).locale.languageCode),
                style: Theme.of(context).textTheme.headline4.copyWith(color: InvestrendTheme.of(context).textWhite, fontWeight: FontWeight.w600),
              ),
              SizedBox(
                height: 8.0,
              ),
              Text(
                widget.themes.getDescription(language: EasyLocalization.of(context).locale.languageCode),
                style: InvestrendTheme.of(context).small_w400.copyWith(color: InvestrendTheme.of(context).textWhite),
              ),
              SizedBox(
                height: 24.0,
              ),
      ...
      child: ValueListenableBuilder(
          ...
          builder: (context, GeneralPriceData data, child) {
            ...
            return ListView.separated(
                ...
                itemCount: data.count() + pre_childs.length,
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  GeneralPrice generalPrice = data.datas.elementAt(index - pre_childs.length);
                  WatchlistPrice gp;
  ...
  Widget createFloatingActionButton(BuildContext context) {
    return SizedBox(
      ...
      child: FloatingActionButton(
        ...
        elevation: 1.0,
        focusElevation: 0.1,
        backgroundColor: InvestrendTheme.darkenColor(widget.themes.background_color, 0.2),
        splashColor: InvestrendTheme.lightenColor(widget.themes.background_color, 0.2),
        child: Padding(
  ...
  Widget createBodyNoScroll(BuildContext context) {
    int membersCount = (widget.themes.member_stocks != null ? widget.themes.member_stocks.length : 0);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
          ...
          child: CircleButton(
            ...
            buttonSize: 40.0,
            imageSize: 20.0,
            imagePadding: const EdgeInsets.only(left: 4.0, right: 8.0, bottom: 4.0, top: 4.0),
            onTap: () {
              Navigator.pop(context);
            },
          ),
                  ...
                  subtitle: Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: InvestrendTheme.of(context).more_support_w400_compact.copyWith(color: priceColor),
                      )
                    ],
                  ),
                );
