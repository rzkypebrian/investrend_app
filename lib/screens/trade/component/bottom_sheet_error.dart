...
class ErrorBottomSheet extends BaseTradeBottomSheet {
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: InvestrendTheme.of(context).regular_w600_compact.copyWith(color: InvestrendTheme.redText),
                ),
              ),
              SizedBox(
                height: 8.0,
              ...
              FractionallySizedBox(
                widthFactor: 0.5,
                child: ComponentCreator.roundedButton(context, 'trade_error_button_try_again'.tr(), InvestrendTheme.redText,
                    InvestrendTheme.of(context).whiteColor, InvestrendTheme.redText, () {
  ...
  Widget createErrorMessage(BuildContext context){
    ...
    return Padding(
      ...
      child: Text(
        text,
        style: InvestrendTheme.of(context).regular_w400.copyWith(color: InvestrendTheme.of(context).greyDarkerTextColor),
