...
class ScreenAmendSell extends StatefulWidget {
  ...
  const ScreenAmendSell(this.amendData, this.updateDataNotifier,
      {Key? key, this.keyboardNotifier})
      : super(key: key);

  @override
  _ScreenAmendSellState createState() =>
      _ScreenAmendSellState(amendData?.orderType, amendData, updateDataNotifier,
...
{
  _ScreenAmendSellState(OrderType? orderType, BuySell? amendData,
