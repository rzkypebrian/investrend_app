...
class UIHelper {
  ...
  static List<TextStyle?>? calculateFontSizes(BuildContext context,
    ...
    for (int i = 0; i < styles!.length; i++) {
      ...
      print('UiHelper.calculateFontSize   style[$i] : ' +
          style!.fontSize.toString());
      widthText += UIHelper.textSize(text, style).width;
    }
    bool? reduceFont = widthText > width!;
    print(
        'UiHelper.calculateFontSize  reduceFont  : $reduceFont  widthText[$widthText] > width[$width]  ');
    if (reduceFont) {
